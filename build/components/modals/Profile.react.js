...
var Profile = function (_Component) {
  ...
  Profile.prototype.handleAvatarChange = function handleAvatarChange(croppedImage) {
    ...
    _MessageAlertActionCreators2.default.show({ title: '头像修改成功', type: 'success', key: new Date().getTime() });
    // .then(
    //   () => {
  ...
  Profile.prototype.handleAvatarRemove = function handleAvatarRemove() {
    ...
    _MessageAlertActionCreators2.default.show({ title: '头像删除成功', type: 'success', key: new Date().getTime() });
  };
