  ...
  function CropAvatarModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.handleClose = function () {
      ...
      var _this$state2 = _this.state,
          ...
          naturalWidth = _this$state2.naturalWidth,
          naturalHeight = _this$state2.naturalHeight;
      ...
      var _this$state3 = _this.state,
          ...
          naturalWidth = _this$state3.naturalWidth,
          naturalHeight = _this$state3.naturalHeight;
      ...
      var _this$state4 = _this.state,
          cropSize = _this$state4.cropSize,
          bili = _this$state4.bili;
