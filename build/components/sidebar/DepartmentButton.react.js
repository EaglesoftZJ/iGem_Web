...
var QuickSearchButton = function (_Component) {
  ...
  QuickSearchButton.calculateState = function calculateState() {
    return {
      show: _DepartmentStore2.default.getState().department_show
    };
  };
  ...
  QuickSearchButton.prototype.openQuickSearch = function openQuickSearch() {
    ...
    _history2.default.push('/im/department');
  };
  ...
  QuickSearchButton.prototype.render = function render() {
    ...
    var className = (0, _classnames2.default)({ selected: show });
    return _react2.default.createElement(
      'footer',
      { className: 'sidebar__department' },
      _react2.default.createElement(
        _rcTooltip2.default,
        {
          ...
          mouseLeaveDelay: 0,
          overlay: _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'tooltip.department' }) },
        _react2.default.createElement(
          'a',
          { onClick: this.openQuickSearch, className: className },
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'button.department' })
        )
      )
    );
  };
...
exports.default = _utils.Container.create(QuickSearchButton);
//# sourceMappingURL=DepartmentButton.react.js.map