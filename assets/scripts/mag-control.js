(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['jquery', './mag-analytics', 'jquery-bridget'], function (jQuery, MagnificentAnalytics, jQueryBridget) {
        return (root[name] = factory(jQuery, MagnificentAnalytics, jQueryBridget));
    });
  } else if (typeof exports === 'object') {
    module.exports = factory(require('jquery'), require('./mag-analytics'), require('jquery-bridget'));
  } else {
    root[name] = factory(root.jQuery, root.MagnificentAnalytics, root.jQueryBridget);
  }
}(window, function ($, MagnificentAnalytics, jQueryBridget) {
  ...
  jQueryBridget('magCtrl', MagnificentControl, $);
