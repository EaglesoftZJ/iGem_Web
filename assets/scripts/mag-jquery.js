...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['./mag', './mag-analytics', 'jquery', 'hammerjs', 'prevent-ghost-click', 'jquery-bridget'],
      function (mag, MagnificentAnalytics, jQuery, Hammer, PreventGhostClick, jQueryBridget) {
        return (root[name] = factory(mag, MagnificentAnalytics, jQuery, Hammer, PreventGhostClick, jQueryBridget));
      }
    );
...
}(window, function (Mag, MagnificentAnalytics, $, Hammer, preventGhostClick, jQueryBridget) {
  ...
  Magnificent.prototype.render = function () {
    ...
    console.log('render', $lens, $zoomed);
    if ($lens) {
  ...
  Magnificent.prototype._init = function () {
    ...
    if (options.position === 'mirror') {
      ...
      console.log('position darg', options.mode, that.eventName('dragstart'));

      if (options.mode === 'inner') {
          console.log('position darg inner')
